...
const topScoreBoard = document.querySelector('.topscore');
let topScore = localStorage.getItem('gameTopScore') || 0;
topScoreBoard.textContent = 'TOP SCORE: ' + topScore;

function checkTopScore() {
    if (score > topScore) {
        topScore = score;
        topScoreBoard.textContent = 'TOP SCORE: ' + topScore;
        localStorage.setItem('gameTopScore', score);
    }
}
