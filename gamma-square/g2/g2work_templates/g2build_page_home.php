...
move_template ( "Home/g2home_01myhead.btxt" , $file2 );
	echo " Change $my_target_file - myHEAD HAS BEEN WRITTEN! <br />" ;

move_template ( "Home/g2home_02mylogo.btxt" , $file2 );
	echo " Change $my_target_file - myLOGO HAS BEEN WRITTEN! <br />" ;

move_template ( "Home/g2home_03mynavi.btxt" , $file2 );
	echo " Change $my_target_file - myNAVIGATION HAS BEEN WRITTEN! <br />" ;

move_template ( "Home/g2home_04myarticel.btxt" , $file2 );
	echo " Change $my_target_file - myARTICEL HAS BEEN WRITTEN! <br />" ;

move_template ( "Home/g2home_05myfoot.btxt" , $file2 );
