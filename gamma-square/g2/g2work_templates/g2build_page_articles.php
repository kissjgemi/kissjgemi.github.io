...
move_template ( "g2articles_01myhead.btxt" , $file2 );
	echo " Change $my_target_file - myHEAD HAS BEEN WRITTEN! <br />" ;

move_template ( "g2articles_02mylogo.btxt" , $file2 );
	echo " Change $my_target_file - myLOGO HAS BEEN WRITTEN! <br />" ;

move_template ( "g2articles_03mynavi.btxt" , $file2 );
	echo " Change $my_target_file - myNAVIGATION HAS BEEN WRITTEN! <br />" ;

move_template ( "g2articles_04myarticel.btxt" , $file2 );
	echo " Change $my_target_file - myARTICEL HAS BEEN WRITTEN! <br />" ;

move_template ( "g2articles_05myfoot.btxt" , $file2 );
