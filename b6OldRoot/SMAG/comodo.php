...
?>
 &nbsp;</span> </font>
	...
	<font color="#FFFFFF"><span style="background-color: #000000;">&nbsp; 
<?php
$my_expiration = $_POST["expirationlist"];
...
$my_title = $_POST["article_title"];
$my_article_head = trim($_POST["article_head"]);
$my_article_body = trim($_POST["article_body"]);
$my_article_footer = trim($_POST["article_footer"]);
